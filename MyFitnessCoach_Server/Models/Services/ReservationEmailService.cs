...
public class ReservationEmailService : IReservationEmailService
{
    ...
    public async Task SendCancellationEmailAsync(string toEmail, string memberName, string instructorName, DateTime startTime)
    {
        var subject = "【MyFitnessCoach】預約取消成功通知";
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
                      ...
                      <tr>
                        <td style="background-color:#eae4dc;padding:40px 40px 32px;border-left:1px solid #d4ccc2;border-right:1px solid #d4ccc2;">
                          ...
                          <p style="font-size:15px;line-height:1.8;color:#6b5e52;margin:0 0 28px;">
                            您已成功取消原定的預約。如果您有使用點數支付，該點數已退還至您的帳戶錢包。以下是取消的預約資訊：
                          </p>
                          ...
                          <div style="background-color:#f5f0eb;border-radius:12px;padding:24px;margin-bottom:28px;border:1px solid #d4ccc2;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td style="padding-bottom:12px;font-size:14px;color:#6b5e52;width:80px;">原定教練</td>
                                <td style="padding-bottom:12px;font-size:14px;color:#1a1613;font-weight:600;">{instructorName}</td>
                              </tr>
                              <tr>
                                <td style="font-size:14px;color:#6b5e52;">原定時間</td>
                                <td style="font-size:14px;color:#1a1613;font-weight:600;">{startTime:yyyy/MM/dd HH:mm}</td>
                              </tr>
                            </table>
                          </div>

                          <div style="background-color:#fdfaf5;border-left:3px solid #ff5252;border-radius:0 10px 10px 0;padding:16px 20px;margin-bottom:28px;">
                            <p style="font-size:13px;line-height:1.7;color:#6b5e52;margin:0;">
                              &#x2139;&nbsp; 如果您希望再次預約，請回到系統選擇適合您的時段。
                            </p>
                          </div>
                        </td>
                      </tr>
